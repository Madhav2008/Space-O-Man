...
WelcomeState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.fillText("Space O Man", game.width / 2, game.height / 2 - 40);
    ctx.font = "20px Arial";
    ctx.fillText("Press 'Space' to start.", game.width / 2, game.height / 2 + 10);
};
...
PlayState.prototype.draw = function(game, dt, ctx) {
    ...
    //  Draw info.
    var textYpos = game.gameBounds.bottom + ((game.height - game.gameBounds.bottom) / 2 - 500) + 14 / 2;
    ctx.font = "40px Arial";
    ctx.fillStyle = '#ffffff';
    var info = "Lives : " + game.lives;
    ctx.textAlign = "left";
    ctx.fillText(info, game.gameBounds.left - 200, textYpos);
    info = "Score : " + game.score;
    ctx.textAlign = "right";
    ctx.fillText(info, game.gameBounds.right + 200, textYpos);
    info = " Level : " + game.level
    ctx.textAlign = "right";
    ctx.fillText(info, game.gameBounds.right - 120, textYpos);
...
LevelIntroState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.font = "33px Arial";
    ctx.fillText("Ready in " + this.countdownMessage, game.width / 2, game.height / 2 + 50);
    return;
};
